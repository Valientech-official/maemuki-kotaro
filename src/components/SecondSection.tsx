  ...
  return (
    <div className="bg-[rgba(228,100,33,0.2)] box-border content-stretch flex flex-col items-start justify-start pb-0 pt-14 px-4 relative w-[390px] overflow-hidden" data-name="Section" data-node-id="1:4456">
      <div className="content-stretch flex flex-col gap-[32.01px] items-start justify-start relative shrink-0 w-full" data-name="Container" data-node-id="1:4457">
        <div className="h-[1310px] relative shrink-0 w-full" data-name="Container" data-node-id="1:4471">
          ...
          <div className="absolute box-border content-stretch flex flex-col gap-4 h-[650px] items-center justify-start left-1/2 pb-0 pt-0 px-0 top-[651px] translate-x-[-50%]" data-name="Container" data-node-id="1:4657">
            <div className="absolute bg-center bg-cover bg-no-repeat bottom-0 h-[580px] left-[-50px] rounded-tl-[300px] rounded-tr-[300px] w-[490px] overflow-hidden" data-name="Gradient+Background" data-node-id="1:4658" style={{ backgroundImage: `url('${imgGradientBackground}')` }} />
            <div className="box-border content-stretch flex flex-col h-[232px] items-center justify-start pb-0 pt-0 px-0 relative shrink-0 w-full z-10" data-name="Container" data-node-id="1:4659">
                  ...
                  <div className="box-border content-stretch flex items-start justify-center overflow-clip pb-[18px] pt-[22px] px-0.5 relative">
                    <div className="content-stretch flex flex-col gap-[11px] items-center justify-center min-w-[354px] relative self-stretch shrink-0" data-name="Container" data-node-id="54:3928">
                      <div className="box-border content-stretch flex gap-2 items-end justify-center pl-0.5 pr-1 py-0 relative shrink-0 w-full" data-name="Container" data-node-id="54:3929">
                        <div className="content-stretch flex flex-col items-start justify-start relative shrink-0" data-name="Container" data-node-id="54:3930">
                          <div className="flex flex-col font-bold justify-center leading-[23.4px] relative shrink-0 text-[#ffffff] text-[19.5px] text-nowrap tracking-[0.488px] whitespace-pre" data-node-id="54:3931">
                            <p className="mb-0">あなたの</p>
                            <p className="">受給額は</p>
                          </div>
                        </div>
                        <div className="content-stretch flex items-center justify-start relative shrink-0" data-name="Container" data-node-id="54:3932">
                          <AnimatedCounter minValue={80} maxValue={200} duration={2} repeatInterval={3000} />
                        </div>
                        <div className="content-stretch flex flex-col items-start justify-start relative shrink-0" data-name="Container" data-node-id="54:3943">
                          <div className="flex flex-col font-bold justify-center leading-[0] relative shrink-0 text-[#ffffff] text-[19.5px] text-nowrap tracking-[0.488px]" data-node-id="54:3944">
                            <p className="leading-[23.4px] whitespace-pre">万円</p>
                          </div>
                        </div>
                      </div>
                      <div className="content-stretch flex items-start justify-center relative shrink-0 w-full" data-name="Container" data-node-id="54:3945">
                        <div className="content-stretch flex flex-col items-start justify-start relative self-stretch shrink-0" data-name="Container" data-node-id="54:3946">
                          <div className="flex flex-col font-bold justify-center leading-[0] relative shrink-0 text-[#ffffff] text-[32.416px] text-nowrap tracking-[0.819px]" data-node-id="54:3947">
